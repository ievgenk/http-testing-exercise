...
describe('Testing for Recipes', () => {
  ...
  it('should return recipes requested on GET', function () {
    return chai.request(app)
      .get('/recipes')
      .then(function (response) {
        ...
        expectedKeys = ['name', 'id', 'ingredients']
  ...
  it('should update existing recipes on POST', function () {
    const newRecipe = {
      "name": "bread",
...
//Did not finish exercise completely